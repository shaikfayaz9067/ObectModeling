...
public class ContestRepository implements IContestRepository {
    ...
    public List<Contest> findAll() {
        List<Contest> contests=this.contestMap.values().stream().collect(Collectors.toList()); 
     return contests;
    }
    ...
    public List<Contest> findAllContestLevelWise(Level level) {
     List<Contest> contests=findAll().stream().filter(c->c.getLevel().equals(level)).collect(Collectors.toList());
     return contests;
    }
