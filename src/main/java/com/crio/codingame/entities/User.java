...
//     if(contests.stream().filter(c->c.equals(contest)) != null){
//            return true;
//     }
//     else{
//         return false;
...
public class User extends BaseEntity {
    ...
    public UserContestQuestions getUserContestQuestions() {
        return userContestQuestions;
    }

    public void setUserContestQuestions(UserContestQuestions userContestQuestions) {
        this.userContestQuestions = userContestQuestions;
    }
